...
/* Diag_Update_Start */
//Temp added here
#define BQ7973X_UV_THRESH_POR_VAL                       (0x00u)
#define BQ7973X_OV_THRESH_POR_VAL                       (0x00u)
#define BQ7973X_OTUT_THRESH_POR_VAL                     (0x00u)
/* Diag_Update_END */
/*********************************************************************************************************************
...
#define BQ7973X_PBCFG_0_START_SEC_VAR_NOINIT_UNSPECIFIED
...
#define BQ7973X_DIAG_CMD_QUEUE_LEN_CHAIN_0      (190u)
...
#define BQ7973X_PBCFG_0_STOP_SEC_VAR_NOINIT_UNSPECIFIED
#include "Cdd_MemMap.h"
...
STATIC CONST(Comif_OperationType, TIBMSCFG_CONS) zBq7973xComOpsCfg_0 =
{
    Bq7973x_ComInit,
    Bq7973x_HandleTransfer,
    Bq7973x_HandleRecieve,
    Bq7973x_Notify,
    Bq7973x_Control,
    Bq7973x_ComDeinit
};
...
STATIC CONST(Bq7973x_RegsType, TIBMSCFG_CONST) rcBq7973xRegsCfg_0 =
{
    {
        {
        ...
        BQ7973X_MPSI_CONF_POR_VAL,  /* uMspi_Conf */
                /* Diag_Update_Start */
        {
            BQ7973X_OV_THRESH_POR_VAL,                              /* uOVUV_Thresh */
            BQ7973X_UV_THRESH_POR_VAL
        },
        BQ7973X_OTUT_THRESH_POR_VAL,                                /* uOTUT_Thresh */
        /* Diag_Update_END */
...
STATIC CONST(Bq7973x_ConfigType, TIBMSCFG_CONST) zBq7973xFuncCfg_0 =
{
    &rcBq7973xRegsCfg_0,    /* register configurations */
...
STATIC CONST(Pmi_OperationType, TIBMSCFG_CONST) zBq7973xFuncOpsCfg_0 =
{
    Bq7973x_Init,
    Bq7973x_TxHandlerProc,
    Bq7973x_RxHandlerProc,
    Bq7973x_ReceiveProc,
    Bq7973x_DataDecode,
    Bq7973x_ServiceProc,
    Bq7973x_NotifyProc,
...
CONST(Pmi_ConfigType, TIBMSCFG_CONST) zPmiCfg_0 =
{
    (void *) &zBq7973xFuncCfg_0,                /* pPmcCfg */
    &zPmiBswCfg_0,                              /* pBswCfg */
    &zBq7973xFuncOpsCfg_0,                      /* pPmcOpsCfg */
...
CONST(Comif_ConfigType, TIBMSCFG_CONST) zPmiComifCfgDirectSpiCfg =
{
    (void*) &zBq7973xComCfg_0,                  /* pComChipCfg      */
    &zBq7973xComOpsCfg_0,                       /* pComifOpsCfg     */
    zPmiComCfg_0,                               /* pCommCfg         */

    1u,                                         /* uComIfaceCfg     */
    COMIF_DIRECT,                               /* eComifTypeCfg    */
    COMIF_BQ7973X_CHIP,                         /* eComifChipCfg    */
    COMIF_SPI,                                  /* ePeripCfg        */
